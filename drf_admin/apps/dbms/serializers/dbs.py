...
class DBServerConfigSerializer(serializers.ModelSerializer):
    ...
    db_version = serializers.CharField(max_length=50, allow_blank=True, default=None)
    db_mark = serializers.CharField(max_length=200, allow_blank=True, default=None)
